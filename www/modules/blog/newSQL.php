...
5) Pаздел Работы. Помимо шаблонов сделать чтобы можно было редактировать и удалять. 
Далее выводить их в разделе работы. 
6)Кнопки Вперед / Назад на странице с постом - удалить их или сделать чтобы они работали
